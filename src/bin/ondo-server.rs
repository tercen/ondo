...
impl OndoRemote for MyServer {
    async fn version(&self, r: Request<EmptyMessage>) -> Result<Response<VersionResponse>, Status> {
        self.rocks_db_accessor.clone().version(r)
    }
    ...
    async fn create_database_server(
        ...
        self.rocks_db_accessor.clone().create_database_server(r)
    }
    ...
    async fn delete_database_server(
        ...
        self.rocks_db_accessor.clone().delete_database_server(r)
    }
    ...
    async fn get_database_server(
        ...
        self.rocks_db_accessor.clone().get_database_server(r)
    }
    ...
    async fn update_database_server(
        ...
        self.rocks_db_accessor.clone().update_database_server(r)
    }

    async fn list_domains(
        &self,
        r: Request<EmptyMessage>,
    ) -> Result<Response<ArrayOfStringResponse>, Status> {
        self.rocks_db_accessor.clone().list_domains(r)
    }
    ...
    async fn create_domain(
        ...
        self.rocks_db_accessor.clone().create_domain(r)
    }
    ...
    async fn delete_domain(
        ...
        self.rocks_db_accessor.clone().delete_domain(r)
    }
    ...
    async fn get_domain(
        ...
        self.rocks_db_accessor.clone().get_domain(r)
    }
    ...
    async fn update_domain(
        ...
        self.rocks_db_accessor.clone().update_domain(r)
    }
    ...
    async fn list_tables(
        ...
        self.rocks_db_accessor.clone().list_tables(r)
    }
    ...
    async fn create_table(
        ...
        self.rocks_db_accessor.clone().create_table(r)
    }
    ...
    async fn delete_table(
        ...
        self.rocks_db_accessor.clone().delete_table(r)
    }
    ...
    async fn get_table(
        ...
        self.rocks_db_accessor.clone().get_table(r)
    }
    ...
    async fn update_table(
        ...
        self.rocks_db_accessor.clone().update_table(r)
    }
    ...
    async fn list_indexes(
        ...
        self.rocks_db_accessor.clone().list_indexes(r)
    }
    ...
    async fn list_values(
        ...
        self.rocks_db_accessor.clone().list_values(r)
    }
    ...
    async fn list_values_by_id_range(
        ...
        self.rocks_db_accessor.clone().list_values_by_id_range(r)
    }
    ...
    async fn list_values_by_id_list(
        ...
        self.rocks_db_accessor.clone().list_values_by_id_list(r)
    }
    ...
    async fn create_index(
        ...
        self.rocks_db_accessor.clone().create_index(r)
    }
    ...
    async fn delete_index(
        ...
        self.rocks_db_accessor.clone().delete_index(r)
    }
    ...
    async fn get_index(
        ...
        self.rocks_db_accessor.clone().get_index(r)   
    }
    ...
    async fn update_index(
        ...
        self.rocks_db_accessor.clone().update_index(r)
    }
    ...
    async fn create_value(
        ...
        self.rocks_db_accessor.clone().create_value(r)
    }
    ...
    async fn delete_value(
        ...
        self.rocks_db_accessor.clone().delete_value(r)
    }
    ...
    async fn get_value(
        ...
        self.rocks_db_accessor.clone().get_value(r)
    }
    ...
    async fn update_value(
        ...
        self.rocks_db_accessor.clone().update_value(r)
    }
    ...
    async fn find_values(
        ...
        self.rocks_db_accessor.clone().find_values(r)
    }
    ...
    async fn find_values_by_range(
        ...
        self.rocks_db_accessor.clone().find_values_by_range(r)
    }
}
